...
#define totalChars 4 //changeable BUT must be accurate for program to run
int realTotalChars = sizeof(message)-1;
// 11, minus 1 because of '/0' aka NULL TERMINATOR char, automatically added at the end

int totalSymbols = 27; //constant
